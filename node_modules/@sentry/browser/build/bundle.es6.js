var Sentry = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  class GlobalHandlers {
       ...
       * @param stacktrace TraceKitStackTrace to be converted to an Event.
       */
      _eventFromIncompleteRejection(stacktrace, error) {
          const event = {
          ...
          if (event.exception.values && event.exception.values[0]) {
              event.exception.values[0].mechanism = {
                  data: Object.assign({ mode: stacktrace.mode }, (stacktrace.incomplete && { incomplete: stacktrace.incomplete }), (stacktrace.message && { message: stacktrace.message }), (stacktrace.name && { name: stacktrace.name })),
                  handled: false,
                  type: stacktrace.mechanism,
              };
          }
